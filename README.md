...
Deliberately **out of scope** — automated tests · structured logging · metrics and
tracing · OpenAPI · DigiLocker document verification · SOS · live ride tracking ·
...
| [`steps.md`](steps.md) | How it was built — development progression, what each stage turned out to require, the dated decision log, and the roadmap |
| [`claude.md`](claude.md) | Engineering context: conventions, invariants, and traps to keep in mind when changing the code |
